class ItsMatchView {
  ...
  template(){
    ...
    <section class="its-match-imgs mb-4r">
      <div class="person1" style="background-image: url(${this.dataUsers?.user1?.profile?.profile_pic || 'assets/imgs/girl1.png'})">
        <div class="icon1">
      ...
      <div class="person2" style="background-image: url(${this.dataUsers?.user2?.profile?.profile_pic || 'assets/imgs/girl2.png'})">
        <div class="icon2">
          <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="its-match-texts d-flex flex-column align-items-center w-100 mb-4 mt-4">
      <h1 class="fw-bold main-color-text title">It’s a match, Jake!</h1>
