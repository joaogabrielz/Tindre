    ...
    <span id="alert"></span>
      ...
      <section class="box-card-actions-view">
        <div class="box-users-discover">
          <div class="card-user">
            <img src="${this.user?.profile?.profile_pic || 'assets/imgs/avatar.png'}" alt="image user" />
            <div class="blur-photo"></div>
          </div>
          <div class="box-data-user">
            <div class="d-flex box-name-user">
              <span class="h3 fw-bold white-color-text mb-0">${this.user?.profile?.firstname} ${this.user?.profile?.lastname}, ${this.age}</span>
            </div>
        ...
        <div
          class="d-flex align-items-center justify-content-center gap-4 mt-4 ${!this.user?.profile?.profile_pic ? "pt-3r" : ""}"
        >
      ...
      <div class="nav-options d-flex justify-content-between">
