class ProfileDetailsView {
  ...
  template() {
    ...
    <div class="nav-header d-flex align-items-center justify-content-end px-1 mt-4">
    <span id="skipInterest" class="btn-skip disabled">Skip</span>
    </div>

    <h1 class="fw-bold black-color-text mt-3">Profile details</h1>
    
    <section class="boxProfile justify-content-center">

      <div class="avatar-content mt-3r mb-3r mx-auto">
        ...
        <img id="avatar-preview" class="avatar-prev br-15p" src="${
          this?.profileModel?.avatar || "./assets/imgs/avatar.png"
        }">
      </div>

      <div class="formSignInUp d-flex flex-column gap-3 mb-3">
